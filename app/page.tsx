...
export default function Home() {
    ...
    const citasDelDiaSeleccionado = citas.filter((cita) => dayjs(cita.fecha).format('YYYY-MM-DD') === fechaSeleccionadaFormato);

    const citasDeHoy = citas.filter((cita) => dayjs(cita.fecha).format('YYYY-MM-DD') === hoy);
